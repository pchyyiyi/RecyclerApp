 ...
 */
public class TopGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_top_group);
        initView();
        initAdatper();
        //设置是否吸顶。
...
//        adapter = new NoFooterAdapter(this, null);
        adapter.setOnHeaderClickListener(new GroupedRecyclerViewAdapter.OnHeaderClickListener() {
            ...
            public void onHeaderClick(GroupedRecyclerViewAdapter adapter, BaseViewHolder holder,
                                      int groupPosition) {
                Toast.makeText(TopGroupActivity.this, "组头：groupPosition = " + groupPosition,
        ...
        adapter.setOnChildClickListener(new GroupedRecyclerViewAdapter.OnChildClickListener() {
            ...
            public void onChildClick(GroupedRecyclerViewAdapter adapter, BaseViewHolder holder,
                ...
                Toast.makeText(TopGroupActivity.this, "子项：groupPosition = " + groupPosition
